...
import { getAuditLogsByAction } from '@/lib/actions/audit';
...
export async function GET(
    ...
    try {
        ...
        const result = await getAuditLogsByAction(params.action, limit);
        ...
        console.error('Error in GET /api/admin/audit-logs/action/[action]:', error);
        return NextResponse.json(
