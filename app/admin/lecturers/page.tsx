...
import { Users, Search, Loader2, Shield, GraduationCap } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-brand-light">
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl font-bold text-brand-dark">Lecturer Management</h1>
                        </div>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                {/* Description */}
                <div className="card p-6 mb-6 bg-gradient-to-r from-brand-orange/5 to-brand-orange/10 border-brand-orange/20">
                    <p className="text-brand-dark/80">
                        <strong>Manage user roles:</strong> Assign or revoke the lecturer role to control who can create courses and upload materials.
                                        ...
                                        <tr key={user.id} className="hover:bg-brand-light/30 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm">
                                                <select
                                                    ...
                                                    className="input text-sm py-1.5 px-3 border-brand-dark/20 focus:border-brand-orange focus:ring-brand-orange/20 transition-all disabled:opacity-50"
                                                >
